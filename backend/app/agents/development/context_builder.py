...
def context_builder_node(state: DevelopmentAgentState) -> Dict[str, Any]:
    ...
    proj_name = approved_srs.get("project_name") or approved_srs.get("title") or project_metadata.get("name") or "Custom Project"
    if proj_name == "Sandbox App" and project_metadata.get("name"):
        proj_name = project_metadata.get("name")

    dev_context = {
        "project_id": project_id,
        "project_name": proj_name,
        "srs_summary": approved_srs.get("executive_summary", "") or approved_srs.get("project_summary", ""),
