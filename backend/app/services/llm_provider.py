...
"""
        ...
        # Scenario 2.5: SDD Emitter / Compiler
            ...
            sdd_dict = {
                ...
                "activity_diagram_mermaid": "graph TD\n  Start([Start]) --> Browse[Browse Items]\n  Browse --> Cart[Add to Cart]\n  Cart --> Check[Checkout Payment]\n  Check --> End([End])",
                ...
                "flow_diagram_mermaid": "graph TD\n  Step1[Browse products] --> Step2[Modify quantities]\n  Step2 --> Step3[Submit stripe payment]",
